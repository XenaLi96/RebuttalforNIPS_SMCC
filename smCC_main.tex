...
\dataset aggregates single-cell data primarily from 10x Genomics (Xenium \& Visium HD) and four in-house DBiC-seq cell-line samples. Each study provides histopathology images, transcriptomic profiles, and relevant sample metadata.
