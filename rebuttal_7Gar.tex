...
\textbf{A2.}\enspace The audit establishes three boundaries:
\begin{itemize}
\item \textbf{New versus public:} the in-house samples contain 54,304 measured
cells; QC removes 315, leaving 53,989: \textbf{0.1907\% new primary versus
99.8093\% public aggregated/harmonized targets}.
\item \textbf{Current versus continuing acquisition:} the broader DBiC-seq pool
contains approximately 200,000 paired cells but is not counted here; one
versioned breast slide explains 99 unique samples versus 100 records.
\item \textbf{Measurement status:} Visium HD entries are derived 2-\(\mu\)m
bin-to-cell targets; Xenium and DBiC-seq are native cell-aligned records.
\end{itemize}
