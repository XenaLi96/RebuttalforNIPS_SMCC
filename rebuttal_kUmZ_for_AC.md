...
**4. Cell alignment construction and value are now explicit.**

Xenium uses native boundaries/transcripts; HD registers native 2-µm bins to CellViT contours, aggregates intersections, resolves conflicts by nearest centroid, and excludes unsupported polygons. In a **9,000-polygon** audit, ±1-µm shifts gave Jaccard **0.706–0.816**, expression cosine **0.936–0.994**, and median absolute UMI change **6.0–13.7%**.
