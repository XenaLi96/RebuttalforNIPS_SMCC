...
\begin{itemize}
\item \textbf{Objective/design:} we now report all 25 release categories under
the matched top-50-HVG, four-spatial-holdout protocol. The final row retains the
primary 30-sample native-Xenium macro.
\end{itemize}
