...
We now report all 25 release categories under the matched top-50-HVG,
four-spatial-holdout protocol. The final row retains the primary 30-sample
native-Xenium macro.
...
The updated benchmark code, fixed splits, configurations, and evaluation scripts
for this table are now available in our
\href{https://anonymous.4open.science/r/sMMC-22M-DB75}{anonymous GitHub
repository}.

Image prediction exceeds coordinate and KNN controls in 28/30 samples. On
